...
@Component({
  ...
  template: `
  <div class="md-colorpicker-input-container" layout="row">
	  <div class="md-colorpicker-preview md-colorpicker-checkered-bg" ng-click="showColorPicker($event)" ng-if="mdColorPreview">
		  <div class="md-colorpicker-result" ng-style="{background: value}"></div>
	  </div>
	  <md-input-container flex>
		  <label><md-icon ng-if="icon">{{icon}}</md-icon>{{label}}</label>
		  <input type="input" ng-model="value" class='md-colorpicker-input'  ng-mousedown="(openOnInput || !mdColorPreview) && showColorPicker($event)"/>
	  </md-input-container>
	  <md-button class="md-icon-button md-colorpicker-clear" ng-if="mdColorClearButton && value" ng-click="clearValue();" aria-label="Clear Color">
		  <md-icon md-svg-icon="clear.svg"></md-icon>
	  </md-button>
  </div>
  `,
  styles: [`
  md-colorpicker .md-colorpicker-input-container,
  [md-colorpicker] .md-colorpicker-input-container {
    position: relative;
  }
  md-colorpicker .md-colorpicker-input-container .md-colorpicker-input::-ms-clear,
  [md-colorpicker] .md-colorpicker-input-container .md-colorpicker-input::-ms-clear {
    display: none;
  }
  md-colorpicker .md-colorpicker-input-container .md-colorpicker-preview,
  [md-colorpicker] .md-colorpicker-input-container .md-colorpicker-preview {
    content: '';
    width: 24px;
    height: 24px;
  ...
  md-colorpicker .md-colorpicker-input-container .md-colorpicker-preview .md-colorpicker-result,
  [md-colorpicker] .md-colorpicker-input-container .md-colorpicker-preview .md-colorpicker-result {
    width: 100%;
    height: 100%;
  }
  md-colorpicker .md-colorpicker-input-container .md-colorpicker-clear,
  [md-colorpicker] .md-colorpicker-input-container .md-colorpicker-clear {
    position: absolute;
    bottom: 42px;
    right: -16px;
  ...
  .md-colorpicker-container .md-colorpicker-arrow {
  ...
  .md-colorpicker-container canvas {
    width: 100%;
    height: 100%;
  }
  .md-colorpicker-container .md-colorpicker-preview {
    flex: 1;
    font-weight: bold;
    font-size: 18px;
    color: #fff;
  ...
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-result {
    position: absolute;
    height: 100%;
    opacity: 1;
    background: #ff0000;
  }
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-result > input {
    position: relative;
    top: -15px;
    opacity: 0;
  }
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-result > div {
    position: relative;
    width: 100%;
  }
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-result > div > input {
    border-width: 0;
  ...
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-result > div > input.switch {
    transition: top cubic-bezier(0.25, 0.8, 0.25, 1) 0.25s, 0.25s opacity ease-out;
    top: 0px;
    opacity: 1;
  }
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-tabs .md-tab,
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-tabs md-tabs-wrapper,
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-tabs md-tabs-canvas,
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-tabs md-pagination-wrapper {
    max-height: 28px;
    height: 28px;
  }
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-tabs md-ink-bar {
  ...
  .md-colorpicker-container .md-colorpicker-preview .md-colorpicker-tabs .md-tab.md-active {
    background: transparent;
  }
  .md-colorpicker-container .md-colorpicker-preview.dark {
    color: #333;
  }
  .md-colorpicker-container .md-colorpicker-preview.dark .md-colorpicker-preview-input {
    color: #333;
  }
  .md-colorpicker-container .md-colorpicker-preview.dark .md-tab {
    background: rgba(0, 0, 0, 0.25);
    color: #333;
  }
  .md-colorpicker-container .md-colorpicker-preview.dark .md-tab.md-active {
    background: transparent;
  }
  .md-colorpicker-container .md-colorpicker-preview.dark md-ink-bar {
    background: rgba(0, 0, 0, 0.5);
  }
  .md-colorpicker-container .md-colorpicker-tabs {
    margin: 0px -8px 0;
  }
  .md-colorpicker-container .md-colorpicker-tabs md-tabs[md-align-tabs=bottom] {
    padding-bottom: 0;
  }
  .md-colorpicker-container .md-colorpicker-tabs .md-tab,
  .md-colorpicker-container .md-colorpicker-tabs md-tabs-wrapper,
  .md-colorpicker-container .md-colorpicker-tabs md-tabs-canvas,
  .md-colorpicker-container .md-colorpicker-tabs md-pagination-wrapper {
    max-height: 36px;
    height: 36px;
  }
  .md-colorpicker-container .md-colorpicker-tabs .md-tab {
  ...
  .md-colorpicker-container .md-colorpicker-tabs .md-tab:last-of-type {
    margin-right: -2px;
  }
  .md-colorpicker-container .md-colorpicker-tabs md-tabs:not(.md-no-tab-content):not(.md-dynamic-height) {
    min-height: 298px;
  }
  .md-colorpicker-container .md-colorpicker-tabs md-tabs:not(.md-no-tab-content):not(.md-dynamic-height) md-tabs-content-wrapper {
    height: 255px;
    margin-bottom: 8px;
  }
  .md-colorpicker-container .md-colorpicker-tabs md-tabs:not(.md-no-tab-content):not(.md-dynamic-height) md-tabs-content-wrapper md-tab-content {
    height: 255px;
    padding: 0px 8px 0;
  }
  .md-colorpicker-container .md-colorpicker-tabs md-tabs:not(.md-no-tab-content):not(.md-dynamic-height) md-tabs-content-wrapper md-tab-content [md-tabs-template] {
    height: 100%;
  }
  .md-colorpicker-container .md-colorpicker-tabs.md-colorpicker-colors {
    margin: 8px -8px -8px;
  }
  .md-colorpicker-container .md-colorpicker-tabs.md-colorpicker-colors md-ink-bar {
    top: auto;
  }
  .md-colorpicker-container .md-colorpicker-tabs.md-colorpicker-colors .md-tab {
    background: rgba(0, 0, 0, 0.075);
  }
  .md-colorpicker-container .md-colorpicker-tabs.md-colorpicker-colors .md-tab.md-active {
    background: #fff;
  }
  .md-colorpicker-container .md-colorpicker-colors {
    overflow: hidden;
    margin-top: 8px;
  }
  .md-colorpicker-container .md-colorpicker-colors .md-colorpicker-marker {
    position: absolute;
    border: 2px solid #fff;
    box-shadow: 0 0 2px 0 rgba(0, 0, 0, 0.5);
  }
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-spectrum] {
    position: relative;
    cursor: crosshair;
    overflow: hidden;
    height: 255px;
  ...
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-spectrum] .md-colorpicker-marker {
    width: 12px;
    height: 12px;
    border-radius: 50%;
  ...
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-hue],
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-alpha] {
    position: relative;
    cursor: crosshair;
    overflow: hidden;
    width: 30px;
  }
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-hue].md-colorpicker-wide,
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-alpha].md-colorpicker-wide {
    width: 67px;
  }
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-hue] .md-colorpicker-marker,
  .md-colorpicker-container .md-colorpicker-colors [md-colorpicker-alpha] .md-colorpicker-marker {
    height: 5px;
    width: 100%;
    border-left: 0;
    border-right: 0;
  ...
  .md-colorpicker-container .md-colorpicker-sliders md-slider.red-slider .md-track-fill {
    background: #d01515;
  }
  .md-colorpicker-container .md-colorpicker-sliders md-slider.red-slider .md-thumb:after {
    background-color: #d01515;
    border-color: #d01515;
  }
  .md-colorpicker-container .md-colorpicker-sliders md-slider.green-slider .md-track-fill {
    background: #19d015;
  }
  .md-colorpicker-container .md-colorpicker-sliders md-slider.green-slider .md-thumb:after {
    background-color: #19d015;
    border-color: #19d015;
  }
  .md-colorpicker-container .md-colorpicker-sliders md-slider.blue-slider .md-track-fill {
    background: #1560d0;
  }
  .md-colorpicker-container .md-colorpicker-sliders md-slider.blue-slider .md-thumb:after {
    background-color: #1560d0;
    border-color: #1560d0;
  }
  .md-colorpicker-container .md-colorpicker-material-palette .md-colorpicker-material-title {
    font-size: 22px;
    line-height: 75px;
    padding: 0 15px;
  ...
  .md-colorpicker-container .md-colorpicker-material-palette .md-colorpicker-material-title.dark {
    color: rgba(255, 255, 255, 0.85);
  }
  .md-colorpicker-container .md-colorpicker-material-palette .md-colorpicker-material-title:not(:first-child) {
    margin-top: 16px;
  }
  .md-colorpicker-container .md-colorpicker-material-palette .md-colorpicker-with-label {
    font-size: 12px;
    line-height: 33px;
    padding: 0 5px;
    color: rgba(0, 0, 0, 0.7);
  }
  .md-colorpicker-container .md-colorpicker-material-palette .md-colorpicker-with-label.dark {
    color: rgba(255, 255, 255, 0.7);
  }
  .md-colorpicker-container .md-colorpicker-material-palette .md-colorpicker-material-colors {
    position: absolute;
  ...
  .md-colorpicker-container .md-colorpicker-history > div > div {
    height: 20px;
    margin: 4px;
    background-color: #fff;
    background-image: linear-gradient(45deg, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%, #ddd), linear-gradient(45deg, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%, #ddd);
  ...
  .md-colorpicker-container .md-colorpicker-history > div > div > div {
    width: 100%;
    height: 100%;
  }
  .md-colorpicker-container .md-colorpicker-history button {
    margin-top: auto;
    margin-left: auto;
  }
  .md-colorpicker-checkered-bg {
    background-color: #fff;
    background-image: linear-gradient(45deg, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%, #ddd), linear-gradient(45deg, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%, #ddd);
    background-size: 8px 8px;
    background-position: 0 0, 4px 4px;
...
//    return {
//      template: '<canvas width="100%" height="100%"></canvas><div class="md-colorpicker-marker"></div>',
//      link: canvas.get,
//      controller: function () {
...
//						var tabs = $element[0].querySelector('.md-colorpicker-colors').getElementsByTagName( 'md-tab' );
...
//        // Variables
//        ///////////////////////////////////
//        var container = angular.element($element[0].querySelector('.md-colorpicker-container'));
//        var resultSpan = angular.element(container[0].querySelector('.md-colorpicker-result'));
//        var previewInput = angular.element($element[0].querySelector('.md-colorpicker-preview-input'));
...
//					<div ng-style="{'background': 'rgb('+value['500'].value[0]+','+value['500'].value[1]+','+value['500'].value[2]+')', height: '75px'}" class="md-colorpicker-material-title" ng-class="{'dark': isDark( value['500'].value )}" ng-click="setPaletteColor($event)">
//						<span>{{key}}</span>
//					</div>
//					<div ng-repeat="(label, color) in value track by $index" ng-style="{'background': 'rgb('+color.value[0]+','+color.value[1]+','+color.value[2]+')', height: '33px'}" class="md-colorpicker-with-label" ng-class="{'dark': isDark( color.value )}" ng-click="setPaletteColor($event)">
//						<span>{{label}}</span>
//					</div>
//				</div>
//				*/
...
//        function createDOM() {
//          var paletteContainer = angular.element(element[0].querySelector('.md-colorpicker-palette'));
//          var materialContainer = angular.element(element[0].querySelector('.md-colorpicker-material-palette'));
...
//          var materialTitle = angular.element('<div class="md-colorpicker-material-title"></div>');
//          var materialRow = angular.element('<div class="md-colorpicker-with-label"></div>');
